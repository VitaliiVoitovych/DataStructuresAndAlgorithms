...
public class ListDequeTests
{
    ...
    public void Clear()
    {
        var deque = new ListDeque<int>([1, 2, 3, 4]);
    ...
    {
        var deque = new ListDeque<int>(1);
        
        deque.PushFront(2);
        
        Assert.Equal(2, deque.Front);
    }
