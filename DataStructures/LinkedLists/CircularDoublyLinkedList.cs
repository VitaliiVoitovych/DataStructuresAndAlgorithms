...
public class CircularDoublyLinkedList<T> : ILinkedList<T>
{
    ...
    public CircularDoublyLinkedList(IEnumerable<T> values)
    {
    ...
    public void AddAtHead(T value)
    {
        ...
        var node = new DoublyNode<T>(value) { Next = Head, Previous = Tail};
    ...
    public void AddAtTail(T value)
    {
        ...
        var node = new DoublyNode<T>(value) { Previous = Tail, Next = Head};
        Tail = Tail.Next = node;
        Head!.Previous = Tail;
        _count++;
    }
